...
const users = [];
const records = [
  { id: randomUUID(), title: "Demo order", status: "active", owner: "demo", priority: "medium", createdAt: new Date().toISOString() }
];
...
app.get("/api/health", (req, res) => {
  res.json({ status: "ok", service: "E-Commerce Platform", uptime: process.uptime() });
});
...
app.listen(port, () => {
  console.log("E-Commerce Platform API listening on " + port);
});
